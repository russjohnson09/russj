...
sudo cp "./russj.us.conf" "/etc/nginx/sites-available/russj.us.conf" -vvv
sudo ln -s "/etc/nginx/sites-available/russj.us.conf" "/etc/nginx/sites-enabled/russj.us.conf" || true
...
cat /etc/nginx/sites-available/russj.us.conf